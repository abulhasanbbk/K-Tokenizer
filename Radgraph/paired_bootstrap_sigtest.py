...
EPOCH   = 1
B_BOOT  = 1000
BASE_PAT = f"Results_Labeller_1_100_percent/results_cxr_base_*/part_1/test_preds_seed-*.pkl"
KTOK_PAT = f"Results_Labeller_1_100_percent/results_cxr_umls_*/part_1/test_preds_seed-*.pkl"
